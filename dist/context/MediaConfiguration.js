...
const MediaConfiguration = ({ networkId, style = {}, children, strings = {}, renderers, }) => {
    ...
    return ((0, jsx_runtime_1.jsx)(MediaContext_1.MediaContext.Provider, Object.assign({ value: newContext }, { children: (0, jsx_runtime_1.jsx)(reactjs_hooks_1.NFTFetchConfiguration, Object.assign({ networkId: newNetworkId }, { children: children }), void 0) }), void 0));
};
